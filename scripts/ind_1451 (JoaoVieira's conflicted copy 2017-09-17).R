...
#
require(stringr)
setwd("/Users/Joao Vieira/Dropbox/PPGEA/2 TRIM/REDES NEURAIS/artigo/")
...
#
#
mydata <- data.frame(ind$Country.or.Area.Name,ind$Series.Code,
...
colnames(mydata) <- c("pais","code",2000:2016)
mydata <- mydata[which(mydata$code=="ER_MRN_MARIN"),]
